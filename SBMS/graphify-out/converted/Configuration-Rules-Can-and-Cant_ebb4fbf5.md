<!-- converted from Configuration-Rules-Can-and-Cant.docx -->
...
- Is the item flagged for it — not just the company?
- Is it a serial item? Most refusals are the one-unit rule.
- Is lot tracking on but system lot numbers off? That closes scanner receiving.
- Is the warehouse flagged Allow Receiving or Allow Picking?
- Is the picking slip already closed off? Nothing can be reset after that.
