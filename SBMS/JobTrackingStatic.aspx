<%@ Page Language="C#" Async="true" AsyncTimeout="600" AutoEventWireup="true" CodeBehind="JobTrackingStatic.aspx.cs" Inherits="SBMS.JobTrackingStatic" %>
<!DOCTYPE html>
            ...
            <div class="container">
                <div class="row 150%">
                    ...
                    <div class="8u 12u$(medium)" style="padding-left:8em">
                        ...
                        <br />
                        <h3 style="padding-top: 0; line-height: 1em"><span class="icon fa-sitemap" style="text-decoration:none"></span>Job Card Tracking</h3>
