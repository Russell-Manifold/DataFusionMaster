<%-- AsyncTimeout: async pages default to 45 SECONDS; Web.config's executionTimeout
     does NOT cover them. Posting a picking slip makes per-line Sage calls, so a large
     slip can exceed 45s and be aborted part-posted. See the note on Receiving.aspx. --%>
<%@ Page Language="C#" Async="true" AsyncTimeout="600" AutoEventWireup="true" CodeBehind="PickingSlip.aspx.cs" Inherits="SBMS.PickingSlip" %>
