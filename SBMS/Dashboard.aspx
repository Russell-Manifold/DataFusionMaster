                        ...
                        <div class="row 150%">
                            ...
                            <div class="10u 12u$(medium)" style="text-align: center">
                                ...
                                <asp:Panel ID="pnlButtons" runat="server">
                                    ...
                                    <asp:LinkButton ID="ibtnPickSlips" runat="server" CssClass="button big" PostBackUrl="~/OSSalesOrders.aspx" ToolTip="See all open sales orders, and thier associated Picking slips or Job cards. Process you Sales Orders from here." OnClientClick="showDiv()" ><img src="images/PickSlips.png" alt="Click Here" class="image fit" /></asp:LinkButton>
                                    <asp:LinkButton ID="ibtnPickTrack" runat="server" CssClass="button big" PostBackUrl="~/PickingSlipTracking.aspx" ToolTip="Track and move all open Picking Slips."><img src="images/Picksliptrack.png" alt="Click Here" class="image fit" /></asp:LinkButton>
                                    <asp:LinkButton ID="ibtnStckCtl" runat="server" CssClass="button big" PostBackUrl="~/StockControl.aspx" ToolTip="Stock Transfers, Adjustments, Reports & Stock counts."><img src="images/StockCounts.png" alt="Click Here" class="image fit" /></asp:LinkButton>
                                    <asp:LinkButton ID="ibtnmrp2" runat="server" CssClass="button big" PostBackUrl="~/FGDemands.aspx" ToolTip="View finished goods materials requirements based on purchase orders, sales orders, stock balances, minimum stock etc."><img src="images/fgmrp.png" alt="Click Here" class="image fit" /></asp:LinkButton>
                                    <asp:Panel ID="PnlForecast" runat="server">
                                        ...
                                        <asp:LinkButton ID="ibtnFCasts" runat="server" CssClass="button big" PostBackUrl="~/ForeCastHeaders.aspx" ToolTip="Add/Edit Sales Forecasts"><img src="images/Forecasta.png" alt="Click Here"class="image fit" /></asp:LinkButton>
                                        <asp:LinkButton ID="ibtnmrp" runat="server" CssClass="button big" PostBackUrl="~/FGDemands.aspx" ToolTip="View finished goods materials requirements based on purchase orders, sales orders, stock balances, minimum stock etc."><img src="images/fgmrp.png" alt="Click Here" class="image fit"/></asp:LinkButton>
                                        <asp:LinkButton ID="ibtnJobTrack" runat="server" CssClass="button big" PostBackUrl="~/JobTracking.aspx" ToolTip="View all open job cards and complete job card workflows."><img src="images/JobTrack.png" alt="Click Here" class="image fit" /></asp:LinkButton>
                                    </asp:Panel>
                                    <asp:Panel ID="PnlProduction" runat="server">
                                        <h5>Module 3: Manufacturing, BOM's and Raw Materials Planning (MRP)</h5>
                                        <asp:LinkButton ID="ibtmWorksOrders" runat="server" CssClass="button big" PostBackUrl="~/WorksOrdersHeaders.aspx" ToolTip="View all current manufacturing or production works orders."><img src="images/worksord.png" alt="Click Here" class="image fit"" /></asp:LinkButton>
                                        <asp:LinkButton ID="ibtmWOrdMgment" runat="server" CssClass="button big" PostBackUrl="~/WorksOrdersManfHeaders.aspx" ToolTip="Record manufacturing/production and allocate raw materials."><img src="images/WOrdFilling.png" alt="Click Here" class="image fit" /></asp:LinkButton>
                                        <asp:LinkButton ID="ibtnRMD" runat="server" CssClass="button big" PostBackUrl="~/ProductionRMD.aspx" ToolTip="View and analyse raw materials demands based on current works orders."><img src="images/rmMrp.png" alt="Click Here" class="image fit" /></asp:LinkButton>
                                    </asp:Panel>
                                 </asp:Panel>
                            </div>
                            <div class="1u 12u$(medium)">&nbsp;</div>
