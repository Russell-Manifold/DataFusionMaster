...
namespace SBMS
{
    public partial class BOMDetailed : BasePage
    {
        ...
        protected void LoadBom()
        {
            ...
            {   
                ...
                if (bomH != null)
                {
                    ...
                    BomAddCostAccounts.Load(DDAddCostAcct, CurrentUser, bomH.AddCostAccountID);
        ...
        protected void LbtnSaveBOM_Click(object sender, EventArgs e)
        {
            ...
            if (!BomAddCostAccounts.Validate(this, DDAddCostAcct, CurrentUser, adc1 + adc2 + adc3)) return;
