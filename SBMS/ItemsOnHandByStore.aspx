<%@ Page Language="C#" Async="true" AsyncTimeout="600" AutoEventWireup="true" CodeBehind="ItemsOnHandByStore.aspx.cs" Inherits="SBMS.ItemsOnHandByStore" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cci" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Items Oh By Store</title>
            ...
            <div class="container">             
                <div class="row 150%">
                    ...
                    <div class="8u 12u$(medium)">
                        ...
                        <asp:LinkButton ID="lbtnAnalysis" runat="server" class="buttonC icon fa-codepen" PostBackUrl="~/ItemsOnHandByStore.aspx" ToolTip="Compare total stock on hand with Sage" >&nbsp;Qty Analysis</asp:LinkButton>
                        ...
                        <h3 style="padding-top:0; line-height:1em">Items On Hand By Store</h3>                    
                    </div>
