<%@ Page Language="C#" Async="true" AsyncTimeout="600" AutoEventWireup="true" CodeBehind="WorksOrdersDetailed.aspx.cs" Inherits="SBMS.WorksOrdersDetailed" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cci" %>
<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Works Order Details</title>
                                    ...
                                    <Columns>
                                        <asp:BoundField DataField="LineID"  />
                                         <asp:TemplateField HeaderText="Item/Kit/BOM" ItemStyle-Width="10em" >
                                                <ItemTemplate >
                                                    <asp:DropDownList ID="DDBOMKIT" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DDBOMKIT_SelectedIndexChanged" Width="100px">
                                       ...
                                       <asp:TemplateField ItemStyle-HorizontalAlign="Right" ItemStyle-Width="3em" >
                                                    <ItemTemplate>
                                                         <asp:LinkButton ID="lbtnLineSave" CommandArgument='<%# Eval("LineID") %>' CommandName="lbtnLineSave" runat="server" CssClass="fa fa-save buttonRed" ToolTip="Save Line" OnClick="lbtnLineSave_Click"> </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Right" >
                                         ...
                                         <asp:TemplateField HeaderText="Lot Number" ItemStyle-Width="8em">
                                             <ItemTemplate>
                                                  <asp:TextBox ID="txtLotNum" runat="server" style="width:8em"  Text='<%# Eval("LotNumber") %>' onblur="convertToUpper(this)" ></asp:TextBox>
                                                   <cci:FilteredTextBoxExtender ID="FilteredTextBoxExtender3" runat="server" TargetControlID="txtLotNum" FilterType="Numbers, UppercaseLetters, LowercaseLetters, Custom" ValidChars=".-/\:*" />
                                             </ItemTemplate>
                                         </asp:TemplateField>
                                        ...
                                        <asp:TemplateField ItemStyle-HorizontalAlign="Right" ItemStyle-Width="2em" >
                                                    <ItemTemplate>
                                                        ...
                                                        <cci:ConfirmButtonExtender ID="lbtnIssue_ConfirmButtonExtender1" runat="server" ConfirmText="Confirm, Delete Works Order Line?" Enabled="True" TargetControlID="lbtnDeleteLine"></cci:ConfirmButtonExtender>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                                <div style="text-align:center">
                                    <asp:LinkButton ID="lbtnWOPrint" runat="server" class="buttonRed icon fa-print" OnClick="lbtnWOPrint_Click" style="margin-right:2em; margin-top:2em">&nbsp;Print Preview</asp:LinkButton>
                                    <asp:LinkButton ID="LbtnSaveWO" runat="server" style="font-size:1em; margin-top:2em; margin-right:2em;" CssClass="icon fa-save buttonSage" OnClick="LbtnSaveWO_Click"> Save Works Order</asp:LinkButton>
                                </div>
