                 ...
                 <div class="row 150%">
                      <div class="col-12 col-12-wide" style="text-align:center">
                          <a href="https://mydatafusion.online" title="My Data Fusion website"><img src="images/Logo.png" style="border-radius:0.25em; float:left" class="logoImg" /></a>
                            ...
                            <h3 style="padding-top:2em; line-height:1em">Picking Slip Tracking</h3>
                        </div>
                     </div>
                    ...
                    <ContentTemplate>
                        <div class="row 150%">
                            <div class="col-12 col-12-wide" style="display: flex; justify-content: center;">
                                <div>
                                    <asp:Panel ID="Panel1" runat="server" DefaultButton="lbtnfind" style="text-align:center; overflow:auto">
                                    <asp:TextBox ID="txtfind" runat="server" placeholder="Find Picking Slip Or Customer" style="text-align:center; width:17em; margin-bottom:1em"></asp:TextBox><asp:LinkButton ID="lbtnfind" runat="server" CssClass="fa fa-search buttonC" OnClick="lbtnfind_Click"></asp:LinkButton>      
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                           <h4 class="modal-title" id="quantityModalHLabel">Move Picking Slip To New Status</h4>
                                           </div>
                                        ...
                                        <div class="modal-footer">
                                            <asp:LinkButton ID="btnSaveQuantity" runat="server" Text=" Yes Move It" CssClass="buttonSage icon fa-thumbs-up" OnClick="btnSaveQuantity_Click"  />
