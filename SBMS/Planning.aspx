<%@ Page Language="C#" Async="true" AsyncTimeout="600" AutoEventWireup="true" CodeBehind="Planning.aspx.cs" Inherits="SBMS.Planning" %>
                    ...
                    <div class="container">
                        <div class="row 150%">
                            ...
                            <div class="8u 12u$(medium)" style="padding-left:8em">
                                ...
                                <br />
                                <h3 style="padding-top: 0; line-height: 1em">MRP: Items Planning</h3>
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Item" ItemStyle-Width="5em">
                                                 ...
                                                 <asp:TemplateField HeaderText="Qty" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" ItemStyle-Width="4em">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtQty" runat="server" Width="4em" style="text-align:center"
                                                      Text='<%# String.Format("{0:N1}" , Eval("PlanQuantity")) %>' onkeydown='<%# "triggerSaveOnEnter(event, \"" + ((GridViewRow)Container).FindControl("lbtnLineSave").ClientID + "\")" %>'></asp:TextBox>
