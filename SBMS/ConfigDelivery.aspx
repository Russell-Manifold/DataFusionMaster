<%@ Page Language="C#" Async="true" AsyncTimeout="600" AutoEventWireup="true" CodeBehind="ConfigDelivery.aspx.cs" Inherits="SBMS.ConfigDelivery" %>
            ...
            <div class="container">
                <div class="row 150%">
                    ...
                    <div class="8u 12u$(medium)">
                        ...
                        <br />
                        <h2 style="padding-top: 0; line-height: 1em">Delivery Methods</h2>
                    </div>
                ...
                <div class="row 150%">
                    ...
                    <div class="6u 12u$(medium)" style="text-align: center">
                        <asp:LinkButton ID="lbtnDelMethod" runat="server" Style="float: right" CssClass="icon fa-user-plus buttonRed"> Add New Delivery Method</asp:LinkButton>
                        <asp:GridView ID="GridDelivery" runat="server" AutoGenerateColumns="false" CssClass="gridview" ToolTip="Open Role" OnRowDataBound="GridDelivery_RowDataBound">
                            ...
                            <Columns>
                                <asp:BoundField DataField="DelID" />
                                <asp:BoundField HeaderText="Method" DataField="DelivMethod1" ReadOnly="True" />
                                <asp:TemplateField HeaderText="Active" ItemStyle-Width="8em" ItemStyle-BackColor="Wheat" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkActive" runat="server" Checked='<%# Eval("DelActive") %>' AutoPostBack="true" OnCheckedChanged="chkActive_CheckedChanged" />
                                    </ItemTemplate>
                                </asp:TemplateField>
                            </Columns>
                        </asp:GridView>
