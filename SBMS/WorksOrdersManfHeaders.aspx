<%@ Page Language="C#" Async="true" AsyncTimeout="600" AutoEventWireup="true" CodeBehind="WorksOrdersManfHeaders.aspx.cs" Inherits="SBMS.WorksOrdersManfHeaders" %>
            ...
            <div class="container">             
                   <div class="row 150%">
                       <div class="col-12 col-12-wide" style="text-align:center">
                           ...
                           <h3 style="padding-top:2em; line-height:1em">Works Order Fulfilment</h3>
                       </div>
                    </div>         
                <div class="row 150%">
                            ...
                            <ContentTemplate>
                                ...
                                <asp:Panel ID="Panel1" runat="server">
                                    <table style="width: 100%">
                                        <tr>
                                           <td></td>
                                            <td>
                                                <asp:Panel ID="Panel2" runat="server" DefaultButton="lbtnSearch"><asp:TextBox ID="txtSearch" runat="server" placeholder="Find" Width="150px"></asp:TextBox><asp:LinkButton ID="lbtnSearch" runat="server" CssClass=" fa fa-search" ToolTip="Seach" OnClick="lbtnSearch_Click"></asp:LinkButton></asp:Panel></td>
                                ...
                                <asp:GridView ID="GridWOs" runat="server" AutoGenerateColumns="false" CssClass="gridview" AllowSorting="true" ToolTip="Open Works Order" OnSorting="GridWOs_Sorting" OnRowDataBound="GridWOs_RowDataBound">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="Linked Document" DataField="LinkedDocumentNum" SortExpression="LinkedDocumentNum" />
